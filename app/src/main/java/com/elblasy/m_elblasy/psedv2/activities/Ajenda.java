...
import com.elblasy.m_elblasy.psedv2.adapters.AjendaAdapter;
import com.elblasy.m_elblasy.psedv2.list.AjendaList;
import com.elblasy.m_elblasy.psedv2.loaders.AjendaLoader;
...
public class Ajenda extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<AjendaList>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.elblasy.m_elblasy.psedv2.R.layout.activity_ajenda);

        list = new ArrayList<>();
        progressBar = (ProgressBar) findViewById(com.elblasy.m_elblasy.psedv2.R.id.progressBar);
        emptyView = (ImageView)findViewById(com.elblasy.m_elblasy.psedv2.R.id.emptyview);
        noInternet = (ImageView)findViewById(com.elblasy.m_elblasy.psedv2.R.id.noInternetConnection);

        recyclerView = findViewById(com.elblasy.m_elblasy.psedv2.R.id.ajenda_recycler);
