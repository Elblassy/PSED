...
import com.elblasy.m_elblasy.psedv2.activities.AboutUs;
...
public class AboutUsAdapter extends RecyclerView.Adapter<AboutUsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(com.elblasy.m_elblasy.psedv2.R.layout.team_work, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            gridView = (RecyclerView) itemView.findViewById(com.elblasy.m_elblasy.psedv2.R.id.team_work);
            leader = (ImageView) itemView.findViewById(com.elblasy.m_elblasy.psedv2.R.id.leader);
            nameOfLeader = (TextView) itemView.findViewById(com.elblasy.m_elblasy.psedv2.R.id.name_of_leader);
            bg = (ImageView)itemView.findViewById(com.elblasy.m_elblasy.psedv2.R.id.background_of_teamwork);
            dis = (TextView)itemView.findViewById(com.elblasy.m_elblasy.psedv2.R.id.dis_of_leader);
            team = (TextView)itemView.findViewById(com.elblasy.m_elblasy.psedv2.R.id.title_of_team);
        }
    }
}
